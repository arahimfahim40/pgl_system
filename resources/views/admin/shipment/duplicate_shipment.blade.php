                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="book_number" value="" id="name" class="form-control" placeholder="book number" />
                                    </div>

                                    <div class="form-group">
                                        <label for="name">AES ITN Number</label>
                                        <input type="text" value="" name="itn_number"  class="form-control" placeholder="AES ITN Number" />
                                    </div>
                                    <div class="form-group">
                                        <label for="name"> Container Number</label>
                                        <input type="text" value="" name="cont_number"  class="form-control" placeholder=" Container Number" />
                                    </div>
                                    <div class="form-group">
